...
namespace RunShawn.Web.Areas.Admin.Controllers
{
    ...
    public partial class AccountController : Controller
    {
        ...
        // GET: /Account/Login
        [AllowAnonymous]
        public virtual ActionResult Login(string returnUrl, LoginViewModel model)
        {
            model.Email = "admin@runshawn.com";
            model.Password = "zaq1@WSX";
            //if (model != null)
            //{
        ...
        public virtual async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    {
                        return RedirectToAction(MVC.Customer.Dashboard.Index());
                    }
